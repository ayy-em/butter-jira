...
const BOARD_FIXTURE = [
  { id: 1, name: "CTS", projectKey: "CTS", color: "#4F8EF7",
    sprint: { id: 41, name: "Sprint 41: Payments hardening", goal: "Ship the reconciliation job and clear the review backlog", startsAgo: 9, endsIn: 5 } },
  { id: 2, name: "PLAT", projectKey: "PLAT", color: "#F7914F",
    sprint: { id: 18, name: "PLAT 18: Ledger split", goal: "Split the ledger writer and keep the old path behind a flag", startsAgo: 9, endsIn: 5 } },
