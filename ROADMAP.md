...
M3 (roster). **Next up** — every dependency is in place, including the two things
added ahead of time for it: the snapshot's `byPerson` block and the write layer's
50-issue sprint-move batching.
